  ...
  Future<void> fetchTeachers() async {
    try {
      final response = await http.get(
        Uri.parse(
            Constants.apiUrl + '/api/teachers/'), // Api URL-ni o'zgartiring
      );
                          ...
                          children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    height: 20.0,
                                    color:
                                        Colors.white, // Skeleton loader uchun
                                  ),
                                  SizedBox(height: 10),
                                  Container(
                                    width: double.infinity,
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: Colors.white,
                                shape: BoxShape
                                    .circle, // Shu yerga Border Radius qo'yish uchun
                              ),
                            )
                          ],
                        ),
